...
export class PromotionDialog extends Extension {
	constructor(chessboard, props) {
		...
		this.promotionDialogGroup = Svg.addElement(chessboard.view.markersTopLayer, 'g', {
	...
	redrawDialog() {
		...
		if (this.state.isShown) {
			...
			if (
				(this.chessboard.getOrientation() === COLOR.white && rank < 5) ||
			...
			const offsetX =
				squareCenterPoint.x + squareWidth > this.chessboard.view.width ? -squareWidth : 0;
			Svg.addElement(this.promotionDialogGroup, 'rect', {
